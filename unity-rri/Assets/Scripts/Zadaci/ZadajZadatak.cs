...
public class ZadajZadatak : MonoBehaviour
{
    ...
    public void PonudiZadatak()
    {
        ...
        nagrada.GetComponent<TextMeshProUGUI>().SetText((zadatak.nagrada + " xp").Replace("\\n", "\n"));
    ...
    public void NijeRjeseno()
    {
        ...
        opis.GetComponent<TextMeshProUGUI>()
            .SetText(
                "Nisu ispunjeni svi moji uvjeti!\nNemoj me razočarat!\n\nŽeliš li nastaviti sa zadatkom?".Replace("\\n",
                    "\n"));
    ...
    public void NemaZadatka()
    {
        ...
        opis.GetComponent<TextMeshProUGUI>()
            .SetText(
                "Pozdrav, prijatelju!\nHvala ti na pomoći\nNemam trenutno nikakav zadatak za tebe. U blizini ima lijepe prirode za razgledavat, samo se pazi vukova!"
                    .Replace("\\n", "\n"));
        nagrada.GetComponent<TextMeshProUGUI>().SetText(zadatak.nagrada.ToString().Replace("\\n", "\n"));
        botunPrihvati.onClick.AddListener(() => prozor.SetActive(false));
        botunOdbij.enabled = false;
