...
public class StatGUI : MonoBehaviour
{
    ...
    private IEnumerator StatsGUI()
    {
        ...
        {
            _stats = Player.instance.playerStats;
            zdravlje.GetComponent<TextMeshProUGUI>().SetText(("Zdravlje: "+_stats.CurrentHealth+"/"+_stats.maxHealth.GetValue()).Replace("\\n","\n"));
            bodovi.GetComponent<TextMeshProUGUI>().SetText(("Bodovi: "+_stats.bodovi.GetValue()+"xp").Replace("\\n","\n"));
